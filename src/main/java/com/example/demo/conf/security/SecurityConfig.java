    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http)
        ...
        http
                ...
                .authorizeHttpRequests((authorize) -> authorize
                        ...
                        .requestMatchers(HttpMethod.DELETE, "/api/departments/**").hasAnyRole(Roles.ADMIN.name, Roles.MANAGER.name)

                        .requestMatchers(HttpMethod.POST, "/api/users").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/users/{id}").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/users/{id}/requests").hasAnyRole(Roles.ADMIN.name, Roles.MANAGER.name)
                        .requestMatchers(HttpMethod.PUT, "/api/users/department").hasAnyRole(Roles.ADMIN.name, Roles.MANAGER.name)

                        .requestMatchers(HttpMethod.GET, "/api/parts/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/parts").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/parts/movement").authenticated()

                        .requestMatchers(HttpMethod.GET, "/api/requests/{id}").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/requests/user/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/requests/status/**").permitAll()

                        .requestMatchers(HttpMethod.POST, "/api/requests").authenticated()
                        .requestMatchers(HttpMethod.PUT, "/api/requests/{id}/approve").hasRole(Roles.MANAGER.name)
                        .requestMatchers(HttpMethod.PUT, "/api/requests/reject").hasRole(Roles.MANAGER.name)
                        .requestMatchers(HttpMethod.PUT, "/api/requests/{id}/complete").hasAnyRole(Roles.MANAGER.name, Roles.STOREKEEPER.name)
